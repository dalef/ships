...
public class Game
{
    ...
    private void planningScreen(Player p)
    {
        ...
        screen.getChildren().add(bottomPanel);
        screen.getChildren().add(leftPanel);
        screen.getChildren().add(rightPanel);
        screen.getChildren().add(gamePanel);
        
        screen.getChildren().add(clear);
        screen.getChildren().add(move1);
        screen.getChildren().add(move2);
        screen.getChildren().add(move3);
        screen.getChildren().add(done);
        screen.getChildren().add(back);
        screen.getChildren().add(help);
        screen.getChildren().add(playerName);
        screen.getChildren().add(healthLbl);
        screen.getChildren().add(nhealthBar);
        screen.getChildren().add(healthBar);
        screen.getChildren().add(ammoLbl);
        screen.getChildren().add(nammoBar);
        screen.getChildren().add(ammoBar);
        
        scene = new Scene(screen, SettingsStore.screenHeight, SettingsStore.screenWidth);
    }
