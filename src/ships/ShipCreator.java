...
public class ShipCreator{
    ...
    public ShipCreator() throws IOException {
        ...
        goBackBtn.setOnAction((ActionEvent e) -> {
            Ships.gameStage.setScene(Screens.mainMenu.scene);
        });
        ...
        topCanvas.setOnMouseReleased((MouseEvent event) -> {
            ptc.clearRect(0, 0, 250, 250);
            spaceship.parts.addPart(Ship.createNewPart(event.getX(), event.getY(), level, flipped, angle, piece));
            updateSelection();
        });
        ...
        Ships.gameStage.setScene(scene);
    }
