...
class Menu
{
    ...
    {
        Ships.gameStage.setScene(m.scene);
    }
}
...
class SettingsMenu extends Menu
{
    public SettingsMenu()
    {
        ...
        audioBtn.setOnAction((ActionEvent event) -> {
            setScene(Screens.soundMenu);
        });
        
        graphicsBtn.setOnAction((ActionEvent event) -> {
...
class GraphicsMenu extends Menu
{
    public GraphicsMenu()
    {
        ...
        applyBtn.setOnAction((ActionEvent event) -> {
            Ships.gameStage.setWidth(SettingsStore.screenWidth);
            Ships.gameStage.setHeight(SettingsStore.screenHeight);
        });
        ...
        hiGraphics.setOnAction((ActionEvent event) -> {
            SettingsStore.graphicsQuality = 3;
        });
        
        medGraphics.setOnAction((ActionEvent event) -> {
            SettingsStore.graphicsQuality = 2;
        });
        
        lowGraphics.setOnAction((ActionEvent event) -> {
...
class SoundMenu extends Menu
{
    public SoundMenu()
    {
        ...
        hiVolume.setOnAction((ActionEvent event) -> {
            SettingsStore.volume = 3;
        });
        
        medVolume.setOnAction((ActionEvent event) -> {
            SettingsStore.volume = 2;
        });
        
        lowVolume.setOnAction((ActionEvent event) -> {
...
class MainMenu extends Menu
{
    public MainMenu()
    {
        ...
        playBtn.setOnAction((ActionEvent event) -> {
            Game game = new Game();
            Ships.gameStage.setScene(Game.scene);
        });
        ...
        shipBtn.setOnAction((ActionEvent event) -> {
            ...
            Ships.gameStage.setScene(ShipCreator.scene);
        });
        
        highscoreBtn.setOnAction((ActionEvent event) -> {
